...
const { interpolate, concat, Clock, block } = Animated;
...
class PlayPauseButton extends React.Component {
  ...
  interpolateRotation = interpolate(this.pauseOpacity, {
    inputRange: [0, 1],
    outputRange: [0, 180]
  });

  interpolatePlay = interpolate(this.pauseOpacity, {
    inputRange: [0, 1],
    outputRange: [1, 0]
  });
    ...
    return (
      <TouchableWithoutFeedback onPress={this.props.onPress}>
        <View style={styles.container}>
          <Animated.View
            style={{
              transform: [{ rotateY: concat(this.interpolateRotation, "deg") }]
            }}
          >
            <Animated.View
              style={[
